...
//First Come First Serve Process Scheduler
...
public class FCFSScheduler {
    ...
    public static File log = new File("log_FCFS.txt");                                          // Creation of File element for logging
    ...
    public static File ss = new File("Snapshot_FCFS.txt");                                      //Creation of File Element for Snapshot
        ...
        try {
            if (log.exists()==false) {
                ...
                try {
                    ...
                    logger.write(" ");
                    logger.close();*/
                    log = new File("log_FCFS_"+(a+1)+".txt");                                        //To Change and Try new file name
                    log_creator(a+1);
                }
        ...
        try {
            if (ss.exists()==false) {
                ...
                try {
                    ...
                    logger.write(" ");
                    logger.close();*/
                    ss = new File("Snapshot_FCFS_"+(a+1)+".txt");                                        //To Change and Try new file name
                    ss_creator(a+1);
                }
